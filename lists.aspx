<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="lists.aspx.cs" Inherits="lists" %>
    ...
    <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="fa fa-edit"></i> Students' Lists</li>

            </ol>
            <div class="alert alert-info alert-dismissable">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              Select a class schedule to view the list of students
            </div>
          </div>
        </div><!-- /.row -->
    ...
    <div class="row">
        <div class="col-lg-6">
         ...
         <div class="col-lg-6 text-right">
          <strong>Selected Academic Year: <asp:Label ID="selSchedule" runat="server" Text=""></asp:Label></strong>
         </div>
